\begin{tabular}{ l c r c r r r c r c r r r }
    \toprule

    \multicolumn{1}{l}{\textbf{Text Set}} & \phantom &
    \multicolumn{5}{c}{\textbf{Simple Texter}} & \phantom &
    \multicolumn{5}{c}{\textbf{Attending Texter}} \\

    \cmidrule{3-7}
    \cmidrule{9-13}
    
    &&
    \multicolumn{1}{c}{\textbf{Stat}} & \phantom &
