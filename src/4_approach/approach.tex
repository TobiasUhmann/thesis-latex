...
\begin{figure}[t]
    ...
    \caption{Power model consisting of the Ruler, that processes a query entity's known facts, the Texter, that processes its texts, and the Aggregator, that combines all predictions; All predictions are sorted by confidence and come with sorted lists of explaining rules and sentences}
