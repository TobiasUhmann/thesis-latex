...
%The purpose of this section is to explain those metrics relevant for this work. \autoref{fig:2_basics/2_metrics/1_confusion_matrix} defines basic terms used by the following sections. \autoref{subsec:2_basics/2_metrics/1_accuracy} and~\ref{subsec:2_basics/2_metrics/2_prf} then present the general purpose metrics accuracy, precision, recall and F1 score while \autoref{subsec:2_basics/2_metrics/3_mrr} and~\ref{subsec:2_basics/2_metrics/4_map} discuss the ranking metrics MRR and mAP\@.
