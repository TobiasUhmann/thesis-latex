...
\input{3_basics/4_metrics/1_confusion_matrix/confusion_matrix}

\subsection{Accuracy}
\label{subsec:3_basics/4_metrics/2_accuracy}
\input{3_basics/4_metrics/2_accuracy/accuracy}

\subsection{Precision, Recall and F1}
\label{subsec:3_basics/4_metrics/3_prf}
\input{3_basics/4_metrics/3_prf/prf}

\subsection{Mean Reciprocal Rank}
\label{subsec:3_basics/4_metrics/4_mrr}
\input{3_basics/4_metrics/4_mrr/mrr}

\subsection{Mean Average Precision}
\label{subsec:3_basics/4_metrics/5_map}
\input{3_basics/4_metrics/5_map/map}
